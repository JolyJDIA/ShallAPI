...
public abstract class DEntityBase<T extends net.minecraft.server.v1_15_R1.Entity> implements DEntity {
    ...
    public boolean hasPassenger() {
        return entity.passengers != null && !entity.passengers.isEmpty();
    }

    @Override
    public void setPassenger(DEntity dEntity) {
        removePassenger();
        net.minecraft.server.v1_15_R1.Entity entity = ((DEntityBase) dEntity).getEntityNms();
    ...
    @Override
    public void setEquipment(EnumItemSlot equipment, ItemStack itemStack) {
        entity.setEquipment(equipment, CraftItemStack.asNMSCopy(itemStack));
    }
